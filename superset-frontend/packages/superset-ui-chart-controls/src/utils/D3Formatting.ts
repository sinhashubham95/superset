...
export const D3_FORMAT_OPTIONS: [string, string][] = [
  ...
  ['NUMBER_INDIA', 'NUMBER_INDIA'],
  ['CURRENCY_WORDS_INDIA', 'CURRENCY_WORDS_INDIA'],
  ['NUMBER_WORDS_INDIA', 'NUMBER_WORDS_INDIA'],
  ['CURRENCY_NO_DECIMAL_INDIA', 'CURRENCY_NO_DECIMAL_INDIA'],
  ['NUMBER_NO_DECIMAL_INDIA', 'NUMBER_NO_DECIMAL_INDIA'],
  ['CURRENCY_NO_DECIMAL_WORDS_INDIA', 'CURRENCY_NO_DECIMAL_WORDS_INDIA'],
  ['NUMBER_NO_DECIMAL_WORDS_INDIA', 'NUMBER_NO_DECIMAL_WORDS_INDIA'],
